...
export const EuroIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 10h12"/>
      <path d="M4 14h12"/>
      <path d="M19 6a7.7 7.7 0 0 0-5.2-2A7.9 7.9 0 0 0 6 12c0 4.4 3.5 8 7.8 8 2.2 0 4.2-1 5.2-2.7"/>
    </svg>
);
...
export const BikePlaceholderIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    {/* Dark background, slightly rounded corners to match UI */}
    <rect width="24" height="24" rx="4" fill="#1F2937" />
    
    {/* Bike drawing, translated up to be vertically centered */}
    <g transform="translate(0, -4)" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
        {/* Wheels */}
        <circle cx="6" cy="18" r="3" />
        <circle cx="18" cy="18" r="3" />
        
        {/* Frame */}
        <path d="M11 18L9 12L16 12L11 18" /> {/* Main triangle: bottom bracket -> seat tube -> top tube -> down tube */}
        <line x1="6" y1="18" x2="9" y2="12" /> {/* Seat stay */}
        <line x1="18" y1="18" x2="16" y2="12" /> {/* Fork */}

        {/* Seat post & Saddle */}
        <line x1="9" y1="12" x2="9" y2="10.5" /> {/* Seat post */}
        <line x1="7.5" y1="10.5" x2="10.5" y2="10.5" /> {/* Saddle */}
        
        {/* Handlebars */}
        <path d="M16 12L17.5 11L19 11 C 20 11 20 13 19 13" />
    </g>
  </svg>
);
